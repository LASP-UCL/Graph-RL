...
def main(args):
    ...
    transition_probabilities = np.ones(100)
    for i in obstacles_location:
        transition_probabilities[i] = obstacles_transition_probability

    for i in walls_location:
        transition_probabilities[i] = 0.

    G = node2vec.Graph(nx_G, args.directed, args.p, args.q, transition_probabilities)
